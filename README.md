...
- [📖 Hello Rails Api Only app ](#-hello-rails-api-only-app-)
...
- [Front End App](https://github.com/memicelis/hello-react-front-end)
...
<details>
  ...
  <ul>
    <li><a href="https://github.com/jeremyevans/erubi">React JS</a></li>
  </ul>
</details>
...
```sh
  cd Folder
  git clone git clone https://github.com/memicelis/hello-rails-back-end
```
...
Feel free to check the [repo](https://github.com/memicelis/hello-rails-back-end/issues)
